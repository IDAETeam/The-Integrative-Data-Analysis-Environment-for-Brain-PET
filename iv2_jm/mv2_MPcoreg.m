...
%% generated by mv2_i2m on 21-Feb-2022 16:23:10
...
for i=1:1:size(g4iv2.yyy.cMat,1);                                                                       
    [f1, g1]                    = mv2_genfln(fullfile('pet',[g4iv2.xxx(i).ifc,'.ezm']), [fbc(1:2),i]);  
    [f2, g2]                    = mv2_genfln(fullfile('pet',[g4iv2.xxx(i).ifc,'_',  ...                 
                                                            g4iv2.xxx(i).avr,'.ezi']), [fbc(1:2),i]);   
    if g1>0 && g2<1;            sumFrames(f1,  g4iv2.xxx(i).avr,    'ofl',f2);              end;    end;
