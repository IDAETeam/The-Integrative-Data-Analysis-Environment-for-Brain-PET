function    out = prepTRP(cpt,sme,tad, varargin); 

% prepTRP:      Prepare Ca(t), etc for model parameter estimation
%       
%       usage:      out     = prepTRP(cpt,sme,tad [,opt,val])
%       
...
%                   (default:   0.1 (min) if tLm<=5; 0.5 if 5<tLm<60; 1 if tLm>=60).
