function        out             = mv2_hmcMIT_muse(i1,fbc);
%% generated by mv2_i2m on 25-Feb-2023 20:38:49
% source file: C:\Users\junhua\Desktop\MUSE&DEPENDENCIES\iv2_jm_MUSE\iv2_hmcMIT_muse.m
% 
...
out{2}                          = 'review/approve mean cortex TAC (QC)';
...
% command lines start here: 
% 
[ps, ps6, tim]                  = gei(iii{1},   'spmparams','spm_params','PETtimes');                    
if isempty(ps);                 ps                          = ps6;                                  end; 
if isempty(ps);                                                                                          
    disp('.parameters for PET-to-MRI coregistration not recorded');                 return;         end  
