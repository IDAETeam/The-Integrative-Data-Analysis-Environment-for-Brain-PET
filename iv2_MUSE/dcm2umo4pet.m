...
%
if ~isfield(h,'StudyTime');     h.StudyTime                 = h.AcquisitionTime;                    end;
...
if n~=NumberOfSlices.*NumberOfTimeSlices;
    disp(['problem! Numbers of files (=',int2str(n),') ~= #OfSlices (',int2str(NumberOfSlices),...
        ') x #OfFrames (',int2str(NumberOfTimeSlices),') (=',        ...
