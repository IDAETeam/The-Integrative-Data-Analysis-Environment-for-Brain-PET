...
vNo                             = find(g4vL2{g0f}.aHs==gca);
if ~vNo;                                                                            return;         end;

rxyz                            = [1,2,3;   1,3,2;  2,3,1];
% info  =   [view#, image#, imageH#]:
info                            = [vNo,g4vL2{g0f}.inos(rxyz(vNo,3)),g4vL2{g0f}.iHs(vNo)];
%
...
if s(1)=='n';                   local_select(gcrxy(1:n,   :),   info,   [1,2,0,g4vL2{g0f}.cmd,1]);
else;                           vL2_updatecVOI(gcrxy(1:n,   :), info,   [2,1,1,g4vL2{g0f}.cmd,1]);  end;
