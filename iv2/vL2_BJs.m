...
if isfield(g4vL2{fNo},'lastSaved') && max(d(:,3))>g4vL2{fNo}.lastSaved;
    set(findobj(fNo, 'Tag','vL2InfoB'),     'String',{' ',' Revision detected since last saved',    ...
        ' Save changes and revist Exit, or', ' Select Exit without saving'},  'FontName','Courier new');
    set(gco,    'Value',1,  'Style','popupmenu',    'String',{'Saved, Exit now','Exit without saving'});
                                                                                    return;         end;
%
if isfield(g4vL2{fNo},'exit_do') && ~isempty(g4vL2{fNo}.exit_do);
                                eval(g4vL2{fNo}.exit_do);                                           end;
...
%
if ~isempty(p0);                g4vL2{fNo}.iM(p0)           = g4vL2{fNo}.iM(p0) + g4vL2{fNo}.cmd;   end;
if ~isempty(p1);                g4vL2{fNo}.iM(p1)           = 1000;                                 end;
%    
figure(fNo);
vL2_IJs('updatetM',             1);
vL2_IJs('updatecM',             1);
