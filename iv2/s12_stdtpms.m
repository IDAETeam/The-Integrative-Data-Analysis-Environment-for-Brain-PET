...
out.gm                          = fullfile(dx0,'e106_snUs12_GM.nii');
out.bmsk                        = fullfile(dx0,'s12_ctx_msk_f03_filled.nii');
out.gm4spm                      = fullfile(dx0,'e106_snUs12_GM4spm.nii');
out.gw4spm                      = fullfile(dx0,'e106_snUs12_GW4spm.nii');
...
out.f4w.bb                      = [ -78,-112,-70;           78,76,85];
out.f4w.vox                     = [2 2 2];
out.xyz                         = fullfile(dx0,'e106_iGM_snUFSsd1_t03.xyz');
out.nii                         = fullfile(dx0,'e106_iGM_snUFSsd1.nii');
out.tcm                         = fullfile(dx0,'e106_iGM_snUFSsd1_tcm.nii');
out.gm                          = fullfile(dx0,'e106_iGM_snUFSsd1_GM.nii');
out.bmsk                        = fullfile(dx0,'e106_iGM_snUFSsd1_GW4spm.nii');
out.gm4spm                      = fullfile(dx0,'e106_iGM_snUFSsd1_GM4spm.nii');
out.gw4spm                      = out.bmsk;
out.mfile                       = which('tmp_info');
out.nii_max380                  = [];
return;
