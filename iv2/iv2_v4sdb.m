...
'snm',      'subjNames',      'cms',   'subject names to use in IDAE sessions (one per subject)',
'g',        'groupNames',     'cms',   'group initials (one char. per group, one per subject)',
...
'%',        '  ',             '   ',   '...',
'age',      'subjAge',        'nxs',   'age (one per subject)',
'sex',      'subjSex',        'cxs',   'sex (M/F per subject)',
...
'%',        '  ',             '   ',   '...',
'mass',     'coldmass',       'nxc',   'injected mass of non-radioactive ligand in micrograms',
'rad',      'RADoseInjected', 'nxc',   'injected dose in mCi (rad=radioactivity dose)',
...
'PK',       'plasmaConc',     'nxc',   'plasma conc. per condition per subject',
'blocker',  'blockingAgent',  'cxs',   'name of blocking agent',
'%',        '  ',             '   ',   '...',
...
'%',        '  ',             '   ',   '...',
'cDA',      'clnDatA',        'cxs',   'generic field for clinical data (character, any length)',
'cDB',      'clnDatB',        'cxs',   'generic field for clinical data (character, any length)',
'cDC',      'clnDatC',        'cxs',   'generic field for clinical data (character, any length)',
'cD0',      'clnDat0',        'nxa',   'generic field for clinical data (character, any length)',
'cD1',      'clnDat1',        'nxa',   'generic field for clinical data (numeric, any length)',
'cD2',      'clnDat2',        'nxa',   'generic field for clinical data (numeric, any length)',
'cD3',      'clnDat3',        'nxa',   'generic field for clinical data (numeric, any length)',
'cD4',      'clnDat4',        'nxa',   'generic field for clinical data (numeric, any length)',
'cD5',      'clnDat5',        'nxa',   'generic field for clinical data (numeric, any length)',
'cD6',      'clnDat6',        'nxa',   'generic field for clinical data (numeric, any length)',
'cD7',      'clnDat7',        'nxa',   'generic field for clinical data (numeric, any length)',
'cD8',      'clnDat8',        'nxa',   'generic field for clinical data (numeric, any length)',
'cD9',      'clnDat9',        'nxa',   'generic field for clinical data (numeric, any length)',
'bDA',      'behDatA',        'cxs',   'generic field for behavioral data (character, any length)',
'bDB',      'behDatB',        'cxs',   'generic field for behavioral data (character, any length)',
'bDC',      'behDatC',        'cxs',   'generic field for behavioral data (character, any length)',
'bD0',      'behDat0',        'nxa',   'generic field for behavioral data (numeric, any length)',
'bD1',      'behDat1',        'nxa',   'generic field for behavioral data (numeric, any length)',
'bD2',      'behDat2',        'nxa',   'generic field for behavioral data (numeric, any length)',
'bD3',      'behDat3',        'nxa',   'generic field for behavioral data (numeric, any length)',
'bD4',      'behDat4',        'nxa',   'generic field for behavioral data (numeric, any length)',
'bD5',      'behDat5',        'nxa',   'generic field for behavioral data (numeric, any length)',
'bD6',      'behDat6',        'nxa',   'generic field for behavioral data (numeric, any length)',
'bD7',      'behDat7',        'nxa',   'generic field for behavioral data (numeric, any length)',
'bD8',      'behDat8',        'nxa',   'generic field for behavioral data (numeric, any length)',
'bD9',      'behDat9',        'nxa',   'generic field for behavioral data (numeric, any length)',   
'tDA',      'tecDatA',        'cxs',   'generic field for technical data (character, any length)',
'tDB',      'tecDatB',        'cxs',   'generic field for technical data (character, any length)',
'tDC',      'tecDatC',        'cxs',   'generic field for technical data (character, any length)',
'tD0',      'tecDat0',        'nxa',   'generic field for technical data (numeric, any length)',
'tD1',      'tecDat1',        'nxa',   'generic field for technical data (numeric, any length)',
'tD2',      'tecDat2',        'nxa',   'generic field for technical data (numeric, any length)',
'tD3',      'tecDat3',        'nxa',   'generic field for technical data (numeric, any length)',
'tD4',      'tecDat4',        'nxa',   'generic field for technical data (numeric, any length)',
'tD5',      'tecDat5',        'nxa',   'generic field for technical data (numeric, any length)',
'tD6',      'tecDat6',        'nxa',   'generic field for technical data (numeric, any length)',
'tD7',      'tecDat7',        'nxa',   'generic field for technical data (numeric, any length)',
'tD8',      'tecDat8',        'nxa',   'generic field for technical data (numeric, any length)',
'tD9',      'tecDat9',        'nxa',   'generic field for technical data (numeric, any length)',   
