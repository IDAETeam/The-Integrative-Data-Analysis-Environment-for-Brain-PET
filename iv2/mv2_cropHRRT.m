...
%% generated by mv2_i2m on 18-Oct-2021 18:37:53
...
out{3}                          = 'review/approve cortex mean TAC (to detect scan problems)';
out{4}                          = 'process segments, if segmented or interrupted scans';
...
['pet/',g4iv2.xxx(fbc(3)).pio,'_rsz.ezm']
['pet/',g4iv2.xxx(fbc(3)).pio,'_rsz_',g4iv2.xxx(fbc(3)).avr,'.ezi']
['pet/',g4iv2.xxx(fbc(3)).pio,'_rsz_means.eza']
['pet/',g4iv2.xxx(fbc(3)).pio,'_rsz_means_ok.txt']
'pet/tra_rsz_qc_log.mat'
'pet/tra_rsz_info.mat'
'pet/tra_rsz_coreg.mat'};
%
return;
%% 
