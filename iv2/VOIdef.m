...
'prefrontal cortex     pFC     76400      precrontalCTx  b';
'orbital gyrus         OG      73000      orbital        b';
'frontal operculum     FO      73400      f.operculum    b';
'orbital operculum     OO      73700      orb.operc      b';
'pars triangularis     PT      74400      pars.triangle  b';
'rectal gyrus          RG      76000      rectal         b';
'olfactory bulb        Ob      51700      olfactory      b';
'frontal pole          FP      51020      frontal pole   b';
'caudal middle frontal cmFr    51050      caudal.m.front b';
'rostral middle frontalrmFr    51015      rostral.m.frontb';
'temporal pole         TP      52020      temporal pole  b';
'fronto-orbital        FOb     31400      fronto-orbital b';
...
'tempotal pole         Tt      52700      temporal pole  b';
...
'pericalcarine ctx     pCx     57700      pericalcarine  b';
...
%
% 'versatile 1           vx      45000      v1             b';
% 'versatile 2           vx      45400      v2             b';
% vascular
'choroid plexus        CPx     44700      choroid plexus x';
...
out.anms            = deblank(astrs(:,  1:22));
out.ais             = deblank(astrs(:,  23:30));
out.vnos            = str2num(astrs(:,  31:35)); 

out.sanms           = deblank(astrs(:,  42:52)); 
out.bx              = astrs(:,      end);
