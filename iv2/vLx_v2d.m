...
gv4VL(i2).v2dInfo(find(gv4VL(i2).v2dInfo(:,1)==get(gNo,'UserData')),    2)  = get(gNo,'Value');
return;
...
if ccc(bHs==gNo)>10.^-3;        set(gNo,'BackgroundColor',  ibgc);                                  end;
