...
% bgcs                            = [0.4,0.8,0;               0.8,0.8,0;          0.4,0.7,0.9;
%                                     0.4,0.9,0.7;            0.4,0.9,0.9;        0.7,0.9,0.4;
%                                     0.9,0.7,0.4;            0.4,0.4,0.9;        0.7,0.4,0.9;
%                                     0.8,0,0;                0.9,0.6,0.8;        0.9,0.9,0.6];
...
for i=1:1:size(bgcs, 1);
    ...
    set(bHs(1),                 'String',                   int2str(i),         ...
                                'CallBack', 'disp(num2str(get(g0o,''BackgroundColor'')));',         ...
