...
% To spatially normalize MRIs using SPM unifiied segmentation method (ver.SPM12)      
%       
...
%
% On v.mat (4x4; the so-called SPM matrix):
%   v.mat(1,1) of v2sn can be positive (IDAE's default in) or negative (SPM12's default) 
%   v.mat(1,1) of out.nii will be negative to be suitable for SPM's statistical analyses  
%
% Special usages:
%   To generate spatially normalized volumes:
%   >> s12_snU(v2sn, output_def.nii, out.nii)
%       note that v.mat of out.nii will be negative
%
%   To transfer image volumes in the standard space to individual MRI's space: 
%   >> s12_snU(v@std-space.nii, output_inv.nii, out.nii)
%       note that v.mat of out.nii will be negative 
%
% Options:      
