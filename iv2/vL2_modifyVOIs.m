...
req(1).str                      = '';
req(1).cb                       = ['d=get(g0o,''UserData''); d(end)=str2num(get(g0o,''string''));', ...
...
if v==2;                        g4vL2{fNo}.iM(p1)           = g4vL2{fNo}.iM(p1) + g4vL2{fNo}.cmd;
                                g4vL2{fNo}.iM(p2)           = g4vL2{fNo}.iM(p2) + g4vL2{fNo}.cmd;
% marking all VOI voxels as 2ndary markings:
else;                           g4vL2{fNo}.iM([p1;p2])      = g4vL2{fNo}.iM([p1;p2]) + 1000;            end;
%    
vL2_IJs('updatetM',             1);
vL2_IJs('updatecM',             1);
vL2_IJs('updatesM',             1);
...
set(bHs(3, i),  'Value',1,  'Style','popupmenu',    'String',{'VOI-2ndary marking conversion',      ...
    ' include 2ndary markings to VOI',' VOI voxels > 2ndary markings', '(hit ''h'' key to revsers)'});
