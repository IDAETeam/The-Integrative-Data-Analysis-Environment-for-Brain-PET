...
%
cc{1}                           = {'FS81','FS45','SN81','SN45'};
c1{1}                           = {'Detailed cortical VOIs by Freesurfer'
                                'Simplied cortical VOIs of FS81'
                                'Detailed cortical VOIs by inversed spatial normalization'
                                'Simplied cortical VOIs of SN81'};
cc{2}                           = {'FS','FSL','SN'};
